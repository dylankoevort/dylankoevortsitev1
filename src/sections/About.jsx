	...
	return (
		<section id="about">
			<div className="max-w-[1540px] mx-auto w-full py-12 px-8 md:px-16 p-4 pb-16">
				...
				<h2 className="text-4xl pb-4 text-light-tertiary font-semibold">GET TO KNOW ME</h2>
				<div className="h-fit w-full sm:p-8">
					{/* <div className="flex justify-center items-center p-4">
						<img src={MeGrad} alt="" className="h-[90%] md:h-[367px] max-h-[350px] w-auto rounded-2xl border-2 border-white" />
					</div> */}
					<div className="flex flex-col items-center justify-center gap-4 text-justify max-w-[60%] mx-auto">
						<p>
