...
const Hero = () => {
	return (
		<section
			id="home"
			className="text-[#e9e9e9] bg-[url(assets/me.jpg)] bg-blend-overlay dark:bg-gray-900 bg-light-greyTwo bg-cover bg-no-repeat bg-center border-b-2 border-b-white duration-500"
		>
